...
data_size = 1000
data = {
    'age': list(np.random.randint(0, 110, size=data_size, dtype=float32)),
    'numPreExstCond':
    list(np.random.randint(0, 4, size=data_size, dtype=float32)),
    'numLocVisits':
    list(np.random.randint(0, 50, size=data_size, dtype=float32)),
